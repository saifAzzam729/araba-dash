...
function AddCouponDiscountModal({isOpen, closeModal, onAddSuccessCb, item = null}) {
    ...
    return (
        <CustomModal translatedHeader={translate("discount.common.add-coupon-discount")} isOpen={isOpen} closeModal={closeModal}>
...
export default AddCouponDiscountModal