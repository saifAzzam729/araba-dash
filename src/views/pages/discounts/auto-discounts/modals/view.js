...
const ViewDiscountModal = ({ isOpen, closeModal, item }) => {
    ...
    return (
        <CustomModal
            translatedHeader={translate("discount.common.discount-details")}
            isOpen={isOpen}
        ...
        >
            <Row>
                ...
                <Col xs={6} sm={4}>
                    <ViewBooleanItem label={translate("discount.forms.active")} value={(discount && discount.active)}/>
                </Col>
                                ...
                                <span className="h5">
                                    {
                                        discount?.userGroup?.map((obj) => (
                                                <Badge className="ms-auto me-1 text-white" color={"light-primary"} pill>
                                                    {obj?.name}
                                                </Badge>
                                            )
                                        )
