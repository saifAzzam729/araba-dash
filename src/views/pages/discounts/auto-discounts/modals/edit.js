...
function EditDiscountModal({isOpen, closeModal, onEditSuccessCb, item = null}) {
    ...
    const promiseProductsOptions = (
        ...
        const perPage = 10;
        const search = params.search;
        ProductsService.getPagination({page: page,
            search: search ,
            limit: perPage,
            locale:preferredTableContentLocale
        }).then((res) => {
    ...
    return (
        <CustomModal translatedHeader={translate("discount.common.edit-discount")} isOpen={isOpen} closeModal={closeModal}>
