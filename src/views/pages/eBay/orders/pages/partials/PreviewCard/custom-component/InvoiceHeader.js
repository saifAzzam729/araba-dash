...
import ResendInvoiceToUserButton from "../../../../partials/ResendInvoiceToUserButton";
            ...
            <CardBody className='invoice-padding pb-0'>
                ...
                <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
                    ...
                    <h4 className='invoice-title'>
                            {translate('common.resend-invoice-to-user')+':'}<ResendInvoiceToUserButton saleOrderId={saleOrder.id}
                        ...
                        <div className='invoice-date-wrapper d-flex align-items-center justify-content-center'>
                            ...
                            <div className="w-50 text-center">
                                <Badge className='text-capitalize mb-1'
                                       color={statusObj[saleOrder.invoice.status.value]}
                                       pill>
            ...
            <CardBody className='invoice-padding pt-0'>
                <Row className='invoice-spacing'>
                    <Col className='p-0' xl='8'>
                        ...
                        <CardText className='mb-25'>{translate('common.userPostalCode')}: {saleOrder.userPostalCode}
                        </CardText>
                        <CardText className='mb-25'>{translate('common.phone-number')}: {saleOrder.userPhoneNumber}
                        </CardText>
                    ...
                    <Col className='p-0 mt-xl-0 mt-2' xl='4'>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        className='fw-bold'>{saleOrder.totalPrice} {saleOrder.buyerCurrencyCode}</span>
                                </td>
                            </tr>
                            <tr>
