...
function AttributeFieldsGroup() {
    ...
    return (
        <Row>
            ...
            <Col xs={12} md={6} lg={4} className={`mb-2 ${WindowBreakpoint.sm < width && width <= WindowBreakpoint.md ? 'w-100 d-flex align-items-center gap-2' : ''}`}>
