...
import {
    includedSettingsKeys
} from "@src/views/pages/multi-type-settings/store-social-links-settings/includedSettingsKeys";
...
export default function () {
    ...
    return (
        <>
            <BreadCrumbs title={"store-social-links"} data={[]}/>
            <TableBase
                columns={columns}
                data={items}
                onPaginate={(page) => {
