...
export default function LatestProductsSalesReportPage() {
  const { preferredTableContentLocale } = useSettingsUiContext();
  const REPORTS_KEY = "latest-products-sales";
  ...
  return (
    <>
      <BreadCrumbs title={"latest-products-sales"} data={[]} />
      <Row>
        <Col md={12}>
