...
const ViewMobileSlider = () => {
    ...
    const goBack = () => {
        navigate(makeLocaleUrl("/mobile-sliders"));
    };
    ...
    return (
        <>
            <BreadCrumbs
                ...
                data={[{ title: translate('common.sliders'), link: "/mobile-sliders" }]}
            />
                    ...
                    <Row className="invoice-add">
                        <Col xl={12}>
                            <Row>
                                ...
                                <Col xs={12} className="mb-2">
                                    {slider?.type === "IMAGE" &&  <img alt={"mobile-slider-img"} src={parseImageUrl(slider?.mediaFileUrl)} width={400}/>}
...
export default ViewMobileSlider
