...
const VerticalNavMenuGroupV2 = ({
    ...
    return (
        <li
            className={classnames('nav-item has-sub mt-1', {
        ...
        >
            ...
            >
                ...
                {item.badge && item.badgeText ? (<Badge className="ms-auto me-1" color={item.badge} pill>
                    {item.badgeText}
                </Badge>) : null}
            </Link>
...
export default VerticalNavMenuGroupV2;
